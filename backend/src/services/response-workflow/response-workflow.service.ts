...
export type ResponseResolutionStatus = 'needs_response' | 'resolved' | 'community_answered' | 'unclear' | 'snoozed' | 'superseded';
export type ResponseResolutionSource = 'creator_reply_detected' | 'creator_reply_ai_confirmed' | 'manual' | 'community_answer' | 'unclear' | 'snoozed' | 'superseded' | null;
